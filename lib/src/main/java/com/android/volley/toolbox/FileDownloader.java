...
public class FileDownloader {
	...
	public class DownloadController {
		...
		private FileDownloadRequest.FileDownloadListener mListener;
		...
		private DownloadController(String storeFilePath, String url, FileDownloadRequest.FileDownloadListener listener) {
