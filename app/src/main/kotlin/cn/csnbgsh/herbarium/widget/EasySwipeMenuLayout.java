...
import cn.csnbgsh.herbarium.R;

import static cn.csnbgsh.herbarium.widget.EasySwipeMenuLayout.State.CLOSE;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (Math.abs(distanceX) < mScaledTouchSlop || Math.abs(distanceY) > Math.abs(distanceX)) {
                    break;
                }
