    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            if (screenResolution.y > screenResolution.x) {
                ...
                int leftOffset = AndroidUtils.dip2px(context, 70);
                int topBarHeight = AndroidUtils.dip2px(context, 50);
                int topOffset = (screenResolution.y -  topBarHeight - height) / 2 + topBarHeight;
                framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
            }
